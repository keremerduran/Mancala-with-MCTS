"""
This file contains the model training loop. It takes raw game data, forms the dataset and trains the model on it for a specified number of epochs using a custom loss function.
"""
...
N = 24 # Normalization value
game_states = [[min(N, stones)/ N for stones in state] for state in game_states]

# Rounding action probabilities to 3 decimal places
